...
import { getShuffledSkills } from "../utils/random";
...
export const Intro = () => {
  ...
  const randomFiveSkills = useMemo(() => {
    return getShuffledSkills(flatSkills);
  }, [flatSkills]);
    ...
    <section className="grid md:grid-cols-2 gap-12 pt-16">
      <div className="space-y-6">
        ...
        <div className="flex gap-4">
          ...
          <a
            href="/assets/cv-satrio-adi-p.pdf"
            target="_blank"
            rel="noopener noreferrer"
